...
<%
    Restaurante cate = (Restaurante) request.getAttribute("restaurante");
%>
...
<html>
    ...
    <body>
        ...
        <br><!-- comment -->
        <div class="container">
             <h1 style="color: white">REGISTRAR NOMBRES</h1>
            <form action="RestauranteServlet" method="post">
                <div class="mb-3">
                    <label for="nombre" class="form-label" style="color: white">NOMBRES:</label>
                    <input type="hidden" name="id" value="<%= cate.getId()%>">
                    <input type="text" name="nombre" id="nombre" value="<%=cate.getNombre()%>">
                </div>
